...
const CONTINENTS = {
  africa: {
    ...
    funFact:
      "Africa has the world's largest desert (Sahara) and is home to amazing animals like lions and elephants!",
    points: [
      // More detailed Africa shape
      485,
      215, // North (Mediterranean coast)
      490,
      220, // Tunisia area
      495,
      230, // Libya
  ...
  antarctica: {
    ...
    points: [
      ...
      120, 580, 200, 575, 280, 580, 360, 575, 440, 580, 520, 575, 600, 580, 680, 575, 760, 580, 780,
      590, 780, 615, 760, 620, 680, 615, 600, 620, 520, 615, 440, 620, 360, 615, 280, 620, 200, 615,
      120, 620, 100, 610, 100, 590
    ]
  },
  ...
  australia: {
    ...
    points: [
      ...
      680,
      425, // North coast (Darwin area)
      705,
      428, // Arnhem Land
      730,
      435, // Gulf of Carpentaria
      750,
      445, // Cape York
      765,
      460, // East coast north
      775,
      480, // Brisbane area
      780,
      500, // Sydney area
      ...
      525, // Perth area
      665,
      510, // West coast south
      658,
      485, // West coast middle
      660,
      460, // West coast north
      670,
      440, // Northwest coast
      678,
      428 // Back to north
  ...
  northAmerica: {
    ...
    points: [
      ...
      240, // Washington
      190,
      225, // British Columbia
      180,
      210, // Alaska coast
      170,
      195, // Gulf of Alaska
      160,
      182, // Aleutian Islands
      150,
      175 // Back to Alaska
    ]
  },
  ...
  southAmerica: {
    ...
    points: [
      ...
      345, // Guyana area
      322,
      358, // Brazil northeast
      330,
      375, // Brazil east bulge
      332,
      400, // Brazil east coast
      335,
      430, // Rio area
      338,
      460, // Brazil south
      ...
      510, // Argentina north
      330,
      535, // Buenos Aires area
      318,
      550, // Patagonia
      300,
      560, // Tierra del Fuego
      285,
      558, // Chile south
      272,
      545, // Chile middle
...
const OCEANS = {
  ...
  atlantic: {
    ...
    isOcean: true,
    areas: [{ x: 365, y: 300, width: 110, height: 340, labelX: 365, labelY: 185 }]
  },
  ...
  indian: {
    ...
    isOcean: true,
    areas: [{ x: 620, y: 420, width: 145, height: 145, labelX: 620, labelY: 420 }]
  },
  ...
  arctic: {
    ...
    isOcean: true,
    areas: [{ x: 450, y: 100, width: 690, height: 55, labelX: 450, labelY: 72 }]
  },
  ...
  southern: {
    ...
    isOcean: true,
    areas: [{ x: 450, y: 565, width: 690, height: 38, labelX: 450, labelY: 547 }]
  }
};
