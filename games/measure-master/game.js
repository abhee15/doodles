...
function initNavigation() {
  gameNav = new GameNavigation('measure-master', {
    screens: ['landing', 'unit-detail', 'sort', 'sort-result', 'quiz', 'quiz-result', 'conversions', 'conv-result', 'scenarios', 'scen-result'],
...
const UNITS = [
    {
        ...
        color: 0xE74C3C, cssColor: '#E74C3C', tagline: 'Tinier than a pencil tip!',
        emoji: '🔬',
    ...
    },
    {
        ...
        color: 0xE67E22, cssColor: '#E67E22', tagline: 'About as wide as your finger!',
        emoji: '🍇',
    ...
    },
    {
        ...
        color: 0xF1C40F, cssColor: '#F1C40F', tagline: 'About as wide as your thumb!',
        emoji: '👍',
    ...
    },
    {
        ...
        color: 0x27AE60, cssColor: '#27AE60', tagline: 'Same length as a ruler!',
        emoji: '📏',
    ...
    },
    {
        ...
        color: 0x2980B9, cssColor: '#2980B9', tagline: '3 rulers laid end to end!',
        emoji: '⚾',
    ...
    },
    {
        ...
        color: 0x8E44AD, cssColor: '#8E44AD', tagline: 'About the height of a door!',
        emoji: '🚪',
    ...
    },
    {
        ...
        color: 0x16A085, cssColor: '#16A085', tagline: '10 football fields in a row!',
        emoji: '🏫',
    ...
    },
    {
        ...
        color: 0x1ABC9C, cssColor: '#1ABC9C', tagline: 'A 15–20 minute walk!',
        emoji: '🛣️',
...
const ALL_SCENARIOS = [
    { scene: '📐 Art Class', story: 'You need 2 feet of string for\nan art project. Your ruler shows\nonly inches. How many inches do you need?', answer: 24, choices: [12, 18, 24, 36], formula: '2 feet × 12 = 24 inches', emoji: '✂️' },
    { scene: '⚾ Baseball Practice', story: 'A baseball bat is about 1 yard long.\nHow many feet is that?', answer: 3, choices: [1, 2, 3, 12], formula: '1 yard = 3 feet', emoji: '⚾' },
    { scene: '🏈 Football Field', story: 'A football field is 100 yards long.\nHow many feet is that?', answer: 300, choices: [100, 200, 300, 400], formula: '100 yards × 3 = 300 feet', emoji: '🏈' },
    { scene: '🚪 New Door', story: 'A door is 7 feet tall.\nHow many inches tall is that?', answer: 84, choices: [70, 78, 84, 96], formula: '7 feet × 12 = 84 inches', emoji: '🚪' },
    { scene: '🎯 Archery Class', story: 'The target is 9 feet away.\nHow many yards away is that?', answer: 3, choices: [1, 2, 3, 4], formula: '9 feet ÷ 3 = 3 yards', emoji: '🎯' },
    { scene: '🏫 Walk to School', story: 'Your school is 2 km from home.\nHow many meters away is it?', answer: 2000, choices: [200, 2000, 20, 20000], formula: '2 km × 1000 = 2000 meters', emoji: '🏫' },
    { scene: '🏊 Swimming Pool', story: 'An Olympic pool is 50 meters long.\nHow many centimeters is that?', answer: 5000, choices: [500, 5000, 50, 50000], formula: '50 m × 100 = 5000 cm', emoji: '🏊' },
    { scene: '🛣️ Road Trip', story: 'A sign says the next town is 5 km away.\nHow many meters is that?', answer: 5000, choices: [500, 5000, 50000, 50], formula: '5 km × 1000 = 5000 meters', emoji: '🛣️' },
    { scene: '🌧️ Rainy Day', story: 'Yesterday it rained 30 mm.\nHow many centimeters of rain fell?', answer: 3, choices: [1, 3, 30, 300], formula: '30 mm ÷ 10 = 3 cm', emoji: '🌧️' },
    { scene: '🥾 Hiking Trail', story: 'The trail is 3,000 meters long.\nHow many kilometers is that?', answer: 3, choices: [3, 30, 300, 3000], formula: '3000 m ÷ 1000 = 3 km', emoji: '🥾' },
    { scene: '🎸 Music Class', story: 'A guitar is about 1 yard long.\nHow many inches is that?', answer: 36, choices: [12, 24, 36, 48], formula: '1 yard = 3 feet, 3 × 12 = 36 inches', emoji: '🎸' },
    { scene: '🛁 Bath Time', story: 'A bathtub is about 150 cm long.\nHow many millimeters is that?', answer: 1500, choices: [15, 150, 1500, 15000], formula: '150 cm × 10 = 1500 mm', emoji: '🛁' },
    { scene: '🏃 Track Day', story: 'You ran 4 km on the track today.\nHow many meters did you run?', answer: 4000, choices: [400, 4000, 40, 40000], formula: '4 km × 1000 = 4000 meters', emoji: '🏃' },
    { scene: '🖍️ Art Supply', story: 'A crayon is about 10 cm long.\nHow many millimeters is that?', answer: 100, choices: [10, 100, 1000, 1], formula: '10 cm × 10 = 100 mm', emoji: '🖍️' },
    { scene: '🚗 Car in the Garage', story: 'A car is about 4 meters long.\nHow many centimeters is that?', answer: 400, choices: [40, 400, 4000, 4], formula: '4 m × 100 = 400 cm', emoji: '🚗' },
    { scene: '🏠 Building a Bookshelf', story: 'You need 5 feet of wood for a shelf.\nHow many inches of wood do you need?', answer: 60, choices: [5, 50, 60, 72], formula: '5 feet × 12 = 60 inches', emoji: '📚' },
    { scene: '🎪 County Fair', story: 'The fair is 3 miles away.\nA mile is 5,280 feet. How many feet away is the fair? (Hint: 3 × 5 = 15, add three zeros!)', answer: 15840, choices: [5280, 10560, 15840, 21120], formula: '3 × 5,280 = 15,840 feet', emoji: '🎡' }
];
...
let convQuestions = [], convIndex = 0, convScore = 0, convLocked = false;
let scenQuestions = [], scenIndex = 0, scenScore = 0, scenLocked = false;
let sortState = { slots: new Array(8).fill(null), bank: [], selected: null };
...
function showUnitGrid(mode) {
    ...
    UNITS.forEach((unit, idx) => {
        ...
        `;
        card.onclick = () => { currentUnitIndex = idx; showUnitDetail(idx, mode); };
...
function renderSortUI() {
    ...
    sortState.bank.forEach(uid => {
        ...
        if (sortState.selected === uid) card.classList.add('selected');
        card.style.setProperty('--unit-color', unit.cssColor);
    ...
    checkBtn.onclick = () => {
        let correct = 0;
        CORRECT_ORDER.forEach((uid, i) => { if (sortState.slots[i] === uid) correct++; });
...
function showQuizQuestion() {
    ...
    document.getElementById('quiz-question').textContent = `Which unit would you use to measure...?\n${q.name}`;
    document.getElementById('quiz-formula').textContent = '';

    const choices = shuffle([
        q.unit,
        ...UNITS.filter(u => u.id !== q.unit).slice(0, 3).map(u => u.id)
    ].slice(0, 4));
